# Function to make better boxplots in ggplot ----------------------------------------------------
...
# Custom vis.gam function -------------------------------------------------


jet.colors <-colorRampPalette(c("#fde725", "#a0da39", "#4ac16d", "#1fa187",
                       ...
                       plot.type = "persp", zlim = NULL, nCol = 50, ...) 
{
  ...
  if (type == "link") 
    ...
    zlab <- paste("Foraging trip duration (days)")
